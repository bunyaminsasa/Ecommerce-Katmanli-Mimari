...
namespace Ecommerce.DAL.Migrations
{
    ...
    [Migration("20210829085634_Brand")]
    partial class Brand
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.DAL.Entitites.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            LastDate = new DateTime(2021, 8, 29, 11, 56, 33, 376, DateTimeKind.Local).AddTicks(9128),
                            LastIPNO = "",
                            Name = "Bekir",
            ...
            modelBuilder.Entity("Ecommerce.DAL.Entitites.Brand", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ecommerce.DAL.Entitites.Product", b =>
                {
                    b.HasOne("Ecommerce.DAL.Entitites.Brand", "Brand")
                        .WithMany("Products")
